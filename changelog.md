### 1.21.1-1.0.4 (2026-09-20)
# Update
* Architectury API (architectury-13.0.8-fabric.jar -> architectury-13.0.11-fabric.jar)
* Client Sort (clientsort-fabric-2.2.2+1.21.1.jar -> clientsort-fabric-3.89.1+1.21.1.jar)
* Concurrent Chunk Management Engine (Fabric) (c2me-fabric-mc1.21.1-0.4.0-alpha.0.19.jar -> c2me-fabric-mc1.21.1-0.4.0-alpha.0.29.jar)
* Fabric API (fabric-api-0.116.13+1.21.1.jar -> fabric-api-0.116.17+1.21.1.jar)
* Ixeris (Ixeris-4.5.2+1.21.1-fabric.jar -> Ixeris-4.6.7+1.21.1-fabric.jar)
* Ksyxis (Ksyxis-1.4.3.jar -> Ksyxis-1.4.4.jar)
* LambDynamicLights - Dynamic Lights (lambdynamiclights-4.8.10+1.21.1.jar -> lambdynamiclights-4.8.11+1.21.1.jar)
* Reese's Sodium Options (reeses-sodium-options-fabric-2.2.3+mc1.21.1.jar -> reeses-sodium-options-fabric-2.2.4+mc1.21.1.jar)
* ScalableLux (ScalableLux-fabric-0.3.0-alpha.0.5-all.jar -> ScalableLux-fabric-0.3.0-alpha.0.7-all.jar)
* Sodium (sodium-fabric-0.8.12+mc1.21.1.jar -> sodium-fabric-0.8.13+mc1.21.1.jar)
* Sodium Extra (sodium-extra-fabric-0.9.3+mc1.21.1.jar -> sodium-extra-fabric-0.9.4+mc1.21.1.jar)

### 26.1.2-1.1.5 (2026-09-20)
# Update
* Client Sort (clientsort-fabric-3.102.5+26.1.2.jar -> clientsort-fabric-3.102.7+26.1.2.jar)
* Concurrent Chunk Management Engine (Fabric) (c2me-fabric-mc26.1.2-0.4.0-alpha.0.31.jar -> c2me-fabric-mc26.1.2-0.4.0-alpha.0.62.jar)
* Fabric API (fabric-api-0.154.2+26.1.2.jar -> fabric-api-0.155.3+26.1.2.jar)
* Fast Server Pings (FastServerPings-1.1.1+26.2.jar -> FastServerPings-1.1.4+26.3.jar)
* Ixeris (Ixeris-4.5.2+26.1.2-fabric.jar -> Ixeris-4.6.7+26.1.2-fabric.jar)
* Ksyxis (Ksyxis-1.4.3.jar -> Ksyxis-1.4.4.jar)
* LambDynamicLights - Dynamic Lights (lambdynamiclights-4.11.0+26.1.2.jar -> lambdynamiclights-4.11.2+26.1.2.jar)
* Lithium (lithium-fabric-0.24.6+mc26.1.2.jar -> lithium-fabric-0.24.7+mc26.1.2.jar)
* Mod Menu (modmenu-18.0.0.jar -> modmenu-18.0.1.jar)
* Reese's Sodium Options (reeses-sodium-options-fabric-2.2.3+mc26.1.2.jar -> reeses-sodium-options-fabric-2.2.4+mc26.1.2.jar)
* Reliable Recipe Viewer (reliable-recipe-viewer-8.6.1+26.1.2-fabric.jar -> reliable-recipe-viewer-8.10.5+26.1.2-fabric.jar)
* Sodium (sodium-fabric-0.9.1+mc26.1.2.jar -> sodium-fabric-0.9.2+mc26.1.2.jar)
* Sodium Extra (sodium-extra-fabric-0.9.3+mc26.1.2.jar -> sodium-extra-fabric-0.9.4+mc26.1.2.jar)

### 26.2-1.4.6 (2026-09-20)
# Update
* Client Sort (clientsort-fabric-3.103.1+26.2.jar -> clientsort-fabric-3.103.3+26.2.jar)
* Concurrent Chunk Management Engine (Fabric) (c2me-fabric-mc26.2-0.4.2-alpha.0.13.jar -> c2me-fabric-mc26.2-0.4.2-alpha.0.52.jar)
* Fabric API (fabric-api-0.154.2+26.2.jar -> fabric-api-0.161.0+26.2.jar)
* Fast Server Pings (FastServerPings-1.1.1+26.2.jar -> FastServerPings-1.1.4+26.3.jar)
* Ixeris (Ixeris-4.5.2+26.2-fabric.jar -> Ixeris-4.6.7+26.2-fabric.jar)
* Ksyxis (Ksyxis-1.4.3.jar -> Ksyxis-1.4.4.jar)
* LambDynamicLights - Dynamic Lights (lambdynamiclights-4.12.2+26.2.jar -> lambdynamiclights-4.12.4+26.2.jar)
* Lithium (lithium-fabric-0.25.2+mc26.2.jar -> lithium-fabric-0.25.3+mc26.2.jar)
* Mod Menu (modmenu-20.0.1.jar -> modmenu-20.0.2.jar)
* Reese's Sodium Options (reeses-sodium-options-fabric-2.2.3+mc26.2.jar -> reeses-sodium-options-fabric-2.2.4+mc26.2.jar)
* Reliable Recipe Viewer (reliable-recipe-viewer-8.6.1+26.2-fabric.jar -> reliable-recipe-viewer-8.10.5+26.2-fabric.jar)
* Sodium (sodium-fabric-0.9.1+mc26.2.jar -> sodium-fabric-0.9.2+mc26.2.jar)
* Sodium Extra (sodium-extra-fabric-0.9.3+mc26.2.jar -> sodium-extra-fabric-0.9.4+mc26.2.jar)
...
* Reese's Sodium Options (reeses-sodium-options-fabric-2.0.5+mc1.21.1.jar -> reeses-sodium-options-fabric-2.1.0+mc1.21.1.jar)

### 26.1.2-1.1.2 (2026-06-21)
# Update
* Client Sort (clientsort-fabric-3.2.3+26.1.2.jar -> clientsort-fabric-3.102.4+26.1.2.jar)
* Concurrent Chunk Management Engine (Fabric) (c2me-fabric-mc26.1.2-0.4.0-alpha.0.12.jar -> c2me-fabric-mc26.1.2-0.4.0-alpha.0.17.jar)
* ModernFix-mVUS (modernfix-5.27.17-build.1.jar -> modernfix-5.27.17-build.2.jar)
* Reese's Sodium Options (reeses-sodium-options-fabric-2.0.5+mc26.1.1.jar -> reeses-sodium-options-fabric-2.1.0+mc26.1.2.jar)
* Reliable Recipe Viewer (reliable-recipe-viewer-8.3.1+26.1.2-fabric.jar -> reliable-recipe-viewer-8.4.0+26.1.2-fabric.jar)

### 26.2-1.4.3 (2026-06-21)
# Update
* Client Sort (clientsort-fabric-3.3.0-beta.1+26.2-pre-2.jar -> clientsort-fabric-3.103.0+26.2.jar)
* Concurrent Chunk Management Engine (Fabric) (c2me-fabric-mc26.2-rc-2-0.4.1-alpha.0.0.jar -> c2me-fabric-mc26.2-0.4.1-alpha.0.9.jar)
* Disable Fog (disablefog-fabric-26.2-2.2.0.jar -> disablefog-fabric-26.2-2.2.1.jar)
* Fabric API (fabric-api-0.152.1+26.2.jar -> fabric-api-0.152.2+26.2.jar)
* Ixeris (Ixeris-4.4.4+26.2-pre-6-fabric.jar -> Ixeris-4.5.0+26.2-fabric.jar)
* LambDynamicLights - Dynamic Lights (lambdynamiclights-4.12.0+26.2.jar -> lambdynamiclights-4.12.2+26.2.jar)
* Mod Menu (modmenu-20.0.0-beta.2.jar -> modmenu-20.0.0-beta.3.jar)
* ModernFix-mVUS (modernfix-5.27.7-build.1.jar -> modernfix-5.27.18-build.1.jar)
* Reese's Sodium Options (reeses-sodium-options-fabric-2.0.5+mc26.2.jar -> reeses-sodium-options-fabric-2.1.0+mc26.2.jar)
* Reliable Recipe Viewer (reliable-recipe-viewer-8.3.1+26.2-pre-5-fabric.jar -> reliable-recipe-viewer-8.4.0+26.2-fabric.jar)
* Sodium Extra (sodium-extra-fabric-0.8.8+mc26.2.jar -> sodium-extra-fabric-0.8.9+mc26.2.jar)
